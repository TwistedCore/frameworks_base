...
/** Quick settings tile: High Brightness Mode **/
public class HighBrightnessTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.icon = HighBrightness
                ? ResourceIcon.get(R.drawable.ic_qs_brightness_high_on_alpha)
                : ResourceIcon.get(R.drawable.ic_qs_brightness_high_off_alpha);
    }
